...
export default function ProfileForm({ data }: ProfileFormData) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <>
      <div className="mx-auto max-w-3xl g">
        <h1 className="text-5xl text-blue-900  font-black uppercase">
          Mi Perfil
        </h1>
        ...
        >
          ...
          <input
            ...
            className="bg-blue-900 w-full p-3 text-white uppercase font-bold hover:bg-blue-700 cursor-pointer transition-colors"
          />
        </form>
      </div>
    </>
